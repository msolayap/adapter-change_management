...
class ServiceNowConnector {
   ...
   */
   iapCallback(responseData, errorMessage) {
       if (errorMessage) {
   ...
   * @memberof ServiceNowConnector
    * @method constructUri
    * @summary - Utility function to Construct URI from different sub parts.
 ...
 */
   ...
   * @memberof ServiceNowConnector
   * @method sendRequest
   * @summary Generic method to make HTTP call the end point by taking all variables as Options.
...
/**
 * @memberof ServiceNowConnector
 * @summary - method to verify whether the ServiceNow API service returns Hibernating response.
 ...
 * @summary Process Results from HTTP Calls to ServiceNow API service.
 ...
 */
 processRequestResults(error, response, body, callback) {
   ...
   * @description Call the ServiceNow POST API. Sets the API call's method and body
